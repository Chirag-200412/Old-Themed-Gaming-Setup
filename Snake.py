...
def start():
    ...
    wn.register_shape("D:\\CHIRAG FOLDER\\Strawberry_2.gif")
    wn.register_shape("D:\\CHIRAG FOLDER\\Snake.gif")
    wn.bgcolor("green")
    wn.width = 840
    wn.height = 600
    wn.tracer(0)
    ...
    #Snake Head
    head = RawTurtle(wn)
    head.shape("D:\\CHIRAG FOLDER\\Snake.gif")
    head.speed(0)
    head.penup()
    head.goto(0,0)
    head.direction = "stop"
    ...
    food.penup()
    food.goto(0,100)
    food.shape("D:\\CHIRAG FOLDER\\Strawberry_2.gif")
    segments = []
    ...
    while True:
        ...
        if head.distance(food)<20:
            ...
            winsound.PlaySound("D:\\CHIRAG FOLDER\\Crunch.wav",winsound.SND_ASYNC)
